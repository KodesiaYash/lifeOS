...
class FinancePlugin(DomainPlugin):
    ...
    def get_tools(self) -> list[ToolDeclaration]:
        return [
            ToolDeclaration(
                tool_id="finance.log_transaction",
            ...
            ToolDeclaration(
                tool_id="finance.get_spending_summary",
            ...
            ToolDeclaration(
                tool_id="finance.get_budget_status",
            ...
            ToolDeclaration(
                tool_id="finance.get_investment_summary",
                name="Get Investment Summary",
    ...
    def get_agents(self) -> list[AgentDeclaration]:
        return [
            AgentDeclaration(
                agent_type="finance.budget_advisor",
                name="Budget Advisor",
    ...
    def get_event_handlers(self) -> list[EventHandlerDeclaration]:
        return [
            EventHandlerDeclaration(
                event_pattern="finance.transaction_logged",
                handler=_on_transaction_logged,
                description="Update budget tracking on new transaction.",
            ),
            EventHandlerDeclaration(
                event_pattern="finance.budget_updated",
                handler=_on_budget_updated,
    ...
    def get_memory_categories(self) -> list[MemoryCategoryDeclaration]:
        return [
            MemoryCategoryDeclaration(
                ...
                description="User's income sources",
            ...
            MemoryCategoryDeclaration(
                ...
                description="Investment risk and preferences",
                example_keys=["risk_tolerance", "preferred_asset"],
            ),
            MemoryCategoryDeclaration(
                category="budget_rule",
                description="Budget rules and limits",
